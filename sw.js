const CACHE='match-hub-v061';
const ASSETS=['./','./index.html','./styles.css','./detail.css','./v05.css','./v051.css','./transfers.css','./app.js','./transfers.js','./manifest.webmanifest','./data/football.json','./data/transfers.json'];
